...
HRESULT CMainApp::Initialize()
{
	...
	FAILED_CHECK_RETURN(m_pGI->Create_Font(L"Font_Default", L"바탕", 15, 20, FW_HEAVY), E_FAIL);
	FAILED_CHECK_RETURN(m_pGI->Create_Font(L"Font_Jinji", L"궁서", 30, 30, FW_THIN), E_FAIL);
