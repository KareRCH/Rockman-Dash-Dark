...
/// 
/// </summary>
class CWeapon_Blade : public CCharacter_Common
{
	DERIVED_CLASS(CCharacter_Common, CWeapon_Blade)

protected:
	explicit CWeapon_Blade();
	explicit CWeapon_Blade(const CWeapon_Blade& rhs);
	virtual ~CWeapon_Blade() = default;
