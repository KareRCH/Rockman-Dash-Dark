...
class CWeapon_SpreadBuster : public CCharacter_Common
{
	DERIVED_CLASS(CCharacter_Common, CWeapon_SpreadBuster)

protected:
	explicit CWeapon_SpreadBuster();
	explicit CWeapon_SpreadBuster(const CWeapon_SpreadBuster& rhs);
	virtual ~CWeapon_SpreadBuster() = default;
