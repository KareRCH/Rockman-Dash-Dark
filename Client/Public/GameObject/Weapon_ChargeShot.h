...
/// 록맨의 버스터
/// </summary>
class CWeapon_ChargeShot : public CCharacter_Common
{
	DERIVED_CLASS(CCharacter_Common, CWeapon_ChargeShot)

protected:
	explicit CWeapon_ChargeShot();
	explicit CWeapon_ChargeShot(const CWeapon_ChargeShot& rhs);
	virtual ~CWeapon_ChargeShot() = default;
...
public:
	static CWeapon_ChargeShot* Create();
	static CWeapon_ChargeShot* Create(const _float3 vPos);
