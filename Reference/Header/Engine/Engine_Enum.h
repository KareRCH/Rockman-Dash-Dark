...
namespace Engine
{
	...
	enum CHANNELID { SOUND_COMMON1, SOUND_COMMON2, SOUND_BGM, SOUND_SYSTEM1, SOUND_SYSTEM2, 
					
					// 플레이어
					SOUND_PLAYER1, SOUND_PLAYER2, SOUND_PLAYER3,
					
					// 일반몬스터
					SOUND_ENEMY1, SOUND_ENEMY2, SOUND_ENEM3, 
					
					// 보스
					SOUND_BOSS1, SOUND_BOSS2, SOUND_BOSS3, SOUND_BOSS4,
					
					// 일반 효과음
					SOUND_VFX, SOUND_VFX2, SOUND_VFX3, SOUND_VFX4, 

					// UI
					SOUND_UI1, SOUND_UI2, MAXCHANNEL };
