...
public:
	...
	virtual HRESULT						Insert_Texture(const wstring& strFilePath, const wstring& strTextureKey, const _bool bPermanent);
	virtual ID3D11ShaderResourceView*	Find_SRV(const wstring& strTextureKey);
	virtual void						Transfer_SRV() {};
	virtual void						Transfer_SRV(ID3D11ShaderResourceView* pTexture, const wstring& strTextureKey);
