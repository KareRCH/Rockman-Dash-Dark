...
CSkinnedModelShaderComp::CSkinnedModelShaderComp(const CSkinnedModelShaderComp& rhs)
{
}

HRESULT CSkinnedModelShaderComp::Initialize_Prototype(void* Arg)
{
...
HRESULT CSkinnedModelShaderComp::Initialize(void* Arg)
{
...
void CSkinnedModelShaderComp::Render(const MATRIX_BUFFER_T& tMatrixBuf, const CAMERA_BUFFER_T tCameraBuf, const BONE_COMMON_BUFFER_T tBoneBuf, const LIGHT_BUFFER_T& tLightBuf)
{
...
CSkinnedModelShaderComp* CSkinnedModelShaderComp::Create(HWND hWnd)
{
...
CComponent* CSkinnedModelShaderComp::Clone(void* Arg)
{
...
void CSkinnedModelShaderComp::Free()
{
	SUPER::Free();
}

HRESULT CSkinnedModelShaderComp::Initialize_Shader(HWND hWnd, const wstring& strVertexShaderKey, const wstring& strPixelShaderKey)
{
...
HRESULT CSkinnedModelShaderComp::Set_ShaderParameter(MATRIX_BUFFER_T tMatrixBuf, CAMERA_BUFFER_T tCameraBuf, BONE_COMMON_BUFFER_T tBoneBuf, LIGHT_BUFFER_T tLightBuf)
{
    ...
    **************/
    ...
    D3D11Context()->PSSetShaderResources(0, 1, m_pTextureView.GetAddressOf());
    ...
    **************/
    ...
    D3D11Context()->Unmap(m_pBoneBuffer.Get(), 0);
...
void CSkinnedModelShaderComp::Render_Shader(_int iIndexCount)
{
