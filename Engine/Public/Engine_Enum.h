...
namespace Engine
{
	...
	enum ECOLLISION_LAYER : _uint_32
	{
		ECOLLAYER_PLAYER			= EBIT_FLAG32_0,
		ECOLLAYER_MONSTER			= EBIT_FLAG32_1,
		ECOLLAYER_BOSSMONSTER		= EBIT_FLAG32_2,
		ECOLLAYER_WALL				= EBIT_FLAG32_3,
		ECOLLAYER_ITEM				= EBIT_FLAG32_4,
		ECOLLAYER_PROJECTILE		= EBIT_FLAG32_5,		//몬스터 투사체 
		ECOLLAYER_PLAYER_ATTACK		= EBIT_FLAG32_6,		// 플레이어 공격
		ECOLLAYER_MONSTER_ATTACK	= EBIT_FLAG32_7,		// 몬스터 일반
		ECOLLAYER_BOSS_SKILL		= EBIT_FLAG32_8,		// 보스 스킬공격 
		ECOLLAYER_TRIGGER			= EBIT_FLAG32_9
	};
