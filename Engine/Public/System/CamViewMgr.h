...
public:
	_bool	Active_Camera(ECamType eType, ECamNum eNum) { m_bActiveCams[ECast(eType)][ECast(eNum)] = true; }
	_bool	Deactive_Camera(ECamType eType, ECamNum eNum) { m_bActiveCams[ECast(eType)][ECast(eNum)] = false; }
